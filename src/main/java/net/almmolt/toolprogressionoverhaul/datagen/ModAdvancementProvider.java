...
public class ModAdvancementProvider extends AdvancementProvider {
    ...
    private static final class ModAdvancementGenerator implements AdvancementProvider.AdvancementGenerator {
        ...
        public void generate(HolderLookup.Provider registries, Consumer<AdvancementHolder> saver, ExistingFileHelper existingFileHelper) {
            ...
            AdvancementHolder tinIngot = createAdvancement(
                    saver, existingFileHelper,
                    "tin_ingot",
            ...
            AdvancementHolder bronzeIngot = createAdvancement(
                    saver, existingFileHelper,
                    "bronze_ingot",
    ...
    public static AdvancementHolder createAdvancement(Consumer<AdvancementHolder> saver, ExistingFileHelper existingFileHelper, String name, Item item, AdvancementHolder parent) {
