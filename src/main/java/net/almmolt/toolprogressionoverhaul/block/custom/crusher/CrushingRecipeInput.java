...
public record CrushingRecipeInput(ItemStack crushingWheel, ItemStack inputStack) implements RecipeInput {
    ...
    public ItemStack getItem(int slot) {
        if (slot == 0) return this.crushingWheel();
        else if (slot == 1) return this.inputStack();
